...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__50321 = cljs.core.instance_QMARK_;
var expr__50322 = reactive_val;
if(cljs.core.truth_(pred__50321.call(null,reagent.ratom.RAtom,expr__50322))){
return "ra";
} else {
if(cljs.core.truth_(pred__50321.call(null,reagent.ratom.RCursor,expr__50322))){
return "rc";
} else {
if(cljs.core.truth_(pred__50321.call(null,reagent.ratom.Reaction,expr__50322))){
return "rx";
} else {
if(cljs.core.truth_(pred__50321.call(null,reagent.ratom.Track,expr__50322))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1600694546624
