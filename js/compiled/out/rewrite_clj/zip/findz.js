...
var len__4499__auto___61312 = arguments.length;
var i__4500__auto___61313 = (0);
while(true){
if((i__4500__auto___61313 < len__4499__auto___61312)){
args__4502__auto__.push((arguments[i__4500__auto___61313]));

var G__61314 = (i__4500__auto___61313 + (1));
i__4500__auto___61313 = G__61314;
continue;
} else {
}
break;
...
rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__61308){
var vec__61309 = p__61308;
var additional = cljs.core.nth.call(null,vec__61309,(0),null);
if(cljs.core.truth_(additional)){
return ((function (vec__61309,additional){
...
;})(vec__61309,additional))
} else {
return ((function (vec__61309,additional){
return (function (p1__61305_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__61305_SHARP_),t);
});
;})(vec__61309,additional))
}
});
...
/** @this {Function} */
rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq61306){
var G__61307 = cljs.core.first.call(null,seq61306);
var seq61306__$1 = cljs.core.next.call(null,seq61306);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61307,seq61306__$1);
});

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__61315,p__61316){
var map__61317 = p__61315;
var map__61317__$1 = ((((!((map__61317 == null)))?(((((map__61317.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61317.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61317):map__61317);
var row = cljs.core.get.call(null,map__61317__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.call(null,map__61317__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.call(null,map__61317__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.call(null,map__61317__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
...
var r = cljs.core.get.call(null,map__61318__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.call(null,map__61318__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last.call(null,cljs.core.filter.call(null,(function (p1__61324_SHARP_){
var and__3911__auto__ = p_QMARK_.call(null,p1__61324_SHARP_);
if(cljs.core.truth_(and__3911__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_.call(null,cljs.core.meta.call(null,clojure.zip.node.call(null,p1__61324_SHARP_)),pos);
} else {
return and__3911__auto__;
}
...
var G__61330 = zloc;
var G__61330__$1 = (((G__61330 == null))?null:f.call(null,G__61330));
if((G__61330__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.call(null,G__61330__$1,f,p_QMARK_);
}
});
...
return rewrite_clj.zip.findz.find.call(null,zloc,f,(function (p1__61332_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__61332_SHARP_),t);
}));
});
...
return rewrite_clj.zip.findz.find_last_by_pos.call(null,zloc,pos,(function (p1__61339_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.tag.call(null,p1__61339_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_.call(null,v))?cljs.core.comp.call(null,v,rewrite_clj.zip.base.sexpr):(function (p1__61346_SHARP_){
return cljs.core._EQ_.call(null,rewrite_clj.zip.base.sexpr.call(null,p1__61346_SHARP_),v);
}));
...
//# sourceMappingURL=findz.js.map?rel=1600694571852
