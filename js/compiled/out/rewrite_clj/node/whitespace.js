...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k59536,else__4175__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k59536,else__4175__auto__);
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__59535){
var self__ = this;
var G__59535__$1 = this;
return (new cljs.core.RecordIter((0),G__59535__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this59537,other59538){
var self__ = this;
var this59537__$1 = this;
return ((!((other59538 == null))) && ((this59537__$1.constructor === other59538.constructor)) && (cljs.core._EQ_.call(null,this59537__$1.whitespace,other59538.whitespace)) && (cljs.core._EQ_.call(null,this59537__$1.__extmap,other59538.__extmap)));
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__59535){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__59541 = cljs.core.keyword_identical_QMARK_;
var expr__59542 = k__4180__auto__;
if(cljs.core.truth_(pred__59541.call(null,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483),expr__59542))){
return (new rewrite_clj.node.whitespace.WhitespaceNode(G__59535,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__59535),null));
}
});
...
rewrite_clj.node.whitespace.WhitespaceNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__59535){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.whitespace.WhitespaceNode(self__.whitespace,G__59535,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.whitespace.map__GT_WhitespaceNode = (function rewrite_clj$node$whitespace$map__GT_WhitespaceNode(G__59539){
return (new rewrite_clj.node.whitespace.WhitespaceNode(new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483).cljs$core$IFn$_invoke$arity$1(G__59539),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__59539,new cljs.core.Keyword(null,"whitespace","whitespace",-1340035483))),null));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k59546,else__4175__auto__){
var self__ = this;
var this__4174__auto____$1 = this;
var G__59550 = k59546;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k59546,else__4175__auto__);
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__59545){
var self__ = this;
var G__59545__$1 = this;
return (new cljs.core.RecordIter((0),G__59545__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"newlines","newlines",-1185451518)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this59547,other59548){
var self__ = this;
var this59547__$1 = this;
return ((!((other59548 == null))) && ((this59547__$1.constructor === other59548.constructor)) && (cljs.core._EQ_.call(null,this59547__$1.newlines,other59548.newlines)) && (cljs.core._EQ_.call(null,this59547__$1.__extmap,other59548.__extmap)));
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__59545){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__59551 = cljs.core.keyword_identical_QMARK_;
var expr__59552 = k__4180__auto__;
if(cljs.core.truth_(pred__59551.call(null,new cljs.core.Keyword(null,"newlines","newlines",-1185451518),expr__59552))){
return (new rewrite_clj.node.whitespace.NewlineNode(G__59545,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__59545),null));
}
});
...
rewrite_clj.node.whitespace.NewlineNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__59545){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.whitespace.NewlineNode(self__.newlines,G__59545,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.whitespace.map__GT_NewlineNode = (function rewrite_clj$node$whitespace$map__GT_NewlineNode(G__59549){
return (new rewrite_clj.node.whitespace.NewlineNode(new cljs.core.Keyword(null,"newlines","newlines",-1185451518).cljs$core$IFn$_invoke$arity$1(G__59549),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__59549,new cljs.core.Keyword(null,"newlines","newlines",-1185451518))),null));
});
...
var comma_59555 = rewrite_clj.node.whitespace.whitespace_node.call(null,", ");
/**
 * Interleave the given seq of nodes with `", "` nodes.
 */
rewrite_clj.node.whitespace.comma_separated = ((function (comma_59555){
return (function rewrite_clj$node$whitespace$comma_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,comma_59555)));
});})(comma_59555))
;
var nl_59556 = rewrite_clj.node.whitespace.newline_node.call(null,"\n");
/**
 * Interleave the given seq of nodes with newline nodes.
 */
rewrite_clj.node.whitespace.line_separated = ((function (nl_59556){
return (function rewrite_clj$node$whitespace$line_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,nl_59556)));
});})(nl_59556))
;
var space_59557 = rewrite_clj.node.whitespace.whitespace_node.call(null," ");
/**
 * Interleave the given seq of nodes with `" "` nodes.
 */
rewrite_clj.node.whitespace.space_separated = ((function (space_59557){
return (function rewrite_clj$node$whitespace$space_separated(nodes){
return cljs.core.butlast.call(null,cljs.core.interleave.call(null,nodes,cljs.core.repeat.call(null,space_59557)));
});})(space_59557))
;
/**
...
//# sourceMappingURL=whitespace.js.map?rel=1600694566131
