...
var G__55157 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__55157;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__55158 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__55158,ch);
...
if(("\\" === ch__$1)){
var ch_55159__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_55159__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_55159__$2);
} else {
}

var G__55160 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__55160;
continue;
}
}
...
var vec__55168 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__55168,(0),null);
var start_column = cljs.core.nth.call(null,vec__55168,(1),null);
...
var G__55171 = cljs.core.conj_BANG_.call(null,a,form);
a = G__55171;
continue;
}
}
...
var _STAR_read_delim_STAR_55172 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_55172;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__55173 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__55173,(0),null);
var start_column = cljs.core.nth.call(null,vec__55173,(1),null);
...
var vec__55176 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__55176,(0),null);
var end_column = cljs.core.nth.call(null,vec__55176,(1),null);
...
var vec__55179 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__55179,(0),null);
var start_column = cljs.core.nth.call(null,vec__55179,(1),null);
...
var vec__55182 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__55182,(0),null);
var end_column = cljs.core.nth.call(null,vec__55182,(1),null);
...
var vec__55185 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__55185,(0),null);
var start_column = cljs.core.nth.call(null,vec__55185,(1),null);
...
var vec__55188 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__55188,(0),null);
var end_column = cljs.core.nth.call(null,vec__55188,(1),null);
...
var sb = (function (){var G__55191 = (new goog.string.StringBuffer());
G__55191.append(initch);
...
var G__55193 = (function (){var G__55192 = sb;
G__55192.append(ch);

return G__55192;
})();
var G__55194 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__55193;
ch = G__55194;
continue;
}
...
switch (G__55197) {
case "\\":
var G__55201 = (function (){var G__55198 = sb;
G__55198.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__55198;
})();
var G__55202 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__55201;
ch = G__55202;
continue;
...
break;
default:
var G__55203 = (function (){var G__55199 = sb;
G__55199.append(ch);

return G__55199;
})();
var G__55204 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__55203;
ch = G__55204;
continue;
...
var vec__55205 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__55205,(0),null);
var end_column = cljs.core.nth.call(null,vec__55205,(1),null);
...
var vec__55208 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__55208,(0),null);
var column = cljs.core.nth.call(null,vec__55208,(1),null);
...
var vec__55213 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__55213,(0),null);
var column = cljs.core.nth.call(null,vec__55213,(1),null);
...
var vec__55218 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__55218,(0),null);
var column = cljs.core.nth.call(null,vec__55218,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__55223 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__55223,(0),null);
var start_column = cljs.core.nth.call(null,vec__55223,(1),null);
...
var vec__55226 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__55226,(0),null);
var end_column = cljs.core.nth.call(null,vec__55226,(1),null);
...
var G__55229 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__55229,true,null,opts,pending_forms);
...
var G__55230 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__55230)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__55230)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__55230)){
...
var _STAR_suppress_read_STAR_55231 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_55231;
}});
...
var G__55232 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__55232,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__55232,rdr,first_line);
...
var G__55236 = matched;
var G__55237 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__55236;
finished = G__55237;
continue;
} else {
...
var _STAR_suppress_read_STAR_55238 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_55238;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env55239 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__55240 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__55240,"(");
...
var G__55241 = (i + (1));
var G__55242 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env55239;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__55243 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__55243);
...
var G__55244 = cljs.core.next.call(null,s__$1);
var G__55245 = ret;
s__$1 = G__55244;
r = G__55245;
continue;
...
var G__55246 = cljs.core.next.call(null,s);
var G__55247 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__55246;
key_vals = G__55247;
continue;
} else {
...
var gensym_env55251 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env55251;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__55252 = token;
var G__55252__$1 = (((G__55252 == null))?null:cljs.core.subs.call(null,G__55252,(1)));
var G__55252__$2 = (((G__55252__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__55252__$1));
var G__55252__$3 = (((G__55252__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__55252__$2));
var G__55252__$4 = (((G__55252__$3 == null))?null:cljs.core.symbol.call(null,G__55252__$3));
if((G__55252__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__55252__$4);
}
})():(function (){var G__55253 = token;
var G__55253__$1 = (((G__55253 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__55253));
if((G__55253__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__55253__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__55264,reader){
var map__55265 = p__55264;
var map__55265__$1 = ((((!((map__55265 == null)))?(((((map__55265.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55265.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55265):map__55265);
var opts = map__55265__$1;
var eof = cljs.core.get.call(null,map__55265__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___55273 = arguments.length;
var i__4500__auto___55274 = (0);
while(true){
if((i__4500__auto___55274 < len__4499__auto___55273)){
args__4502__auto__.push((arguments[i__4500__auto___55274]));

var G__55275 = (i__4500__auto___55274 + (1));
i__4500__auto___55274 = G__55275;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq55271){
var G__55272 = cljs.core.first.call(null,seq55271);
var seq55271__$1 = cljs.core.next.call(null,seq55271);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55272,seq55271__$1);
});


//# sourceMappingURL=reader.js.map?rel=1600694556202
