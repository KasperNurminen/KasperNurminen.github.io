...
var o58955 = temp__4655__auto__;
var temp__4655__auto____$1 = (o58955["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o58956 = temp__4655__auto____$1;
return (o58956["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38984__auto__ = f;
return (o__38984__auto__["toString"]).call(o__38984__auto__);
} else {
return "";
}
}catch (e58957){var _ = e58957;
return "";
}});
...
try{var o__38984__auto___58959 = t;
(o__38984__auto___58959["cljs$lang$ctorPrWriter"]).call(o__38984__auto___58959,t,writer);
}catch (e58958){var __58960 = e58958;
}
...
var char_code = (function (){var o__38984__auto__ = (new String(char$));
return (o__38984__auto__["charCodeAt"]).call(o__38984__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38984__auto__ = String;
return (o__38984__auto__["fromCharCode"]).call(o__38984__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__58961 = num_code;
switch (G__58961) {
case (1):
return (185);
...
var o__38984__auto__ = String;
return (o__38984__auto__["fromCharCode"]).call(o__38984__auto__,superscript_code);
});
/**
...
}catch (e58963){var _e__38991__auto__ = e58963;
return false;
}})())){
...
var vec__58964 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__58964,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o58967 = temp__4655__auto__;
var temp__4655__auto____$1 = (o58967["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o58968 = temp__4655__auto____$1;
return (o58968["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___58975 = arguments.length;
var i__4500__auto___58976 = (0);
while(true){
if((i__4500__auto___58976 < len__4499__auto___58975)){
args__4502__auto__.push((arguments[i__4500__auto___58976]));

var G__58977 = (i__4500__auto___58976 + (1));
i__4500__auto___58976 = G__58977;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__58971){
var vec__58972 = p__58971;
var ns_detector = cljs.core.nth.call(null,vec__58972,(0),null);
...
var G__58978 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__58979 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__58978;
remaining_tokens = G__58979;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq58969){
var G__58970 = cljs.core.first.call(null,seq58969);
var seq58969__$1 = cljs.core.next.call(null,seq58969);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58970,seq58969__$1);
});
...
var vec__58983 = cljs.core.split_with.call(null,(function (p1__58982_SHARP_){
return cljs.core.not_EQ_.call(null,p1__58982_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__58983,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__58983,(1),null);
...
var vec__58986 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__58986,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__58986,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__58989 = cljs.core.rest.call(null,remaining_tokens);
var G__58990 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__58989;
name_tokens = G__58990;
continue;
} else {
...
var vec__58993 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__58993,(0),null);
var arity = cljs.core.nth.call(null,vec__58993,(1),null);
var vec__58996 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__58996,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__58996,(1),null);
var vec__58999 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__58999,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__58999,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__58999,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__58999,(3),null);
...
var vec__59005 = result;
var munged_ns = cljs.core.nth.call(null,vec__59005,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__59005,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__59005,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__59005,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__59005,(4),null);
var arity = cljs.core.nth.call(null,vec__59005,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__59009 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__59009,(0),null);
var args = cljs.core.nth.call(null,vec__59009,(1),null);
var vec__59012 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__59012,(0),null);
var name = cljs.core.nth.call(null,vec__59012,(1),null);
...
var G__59015 = (arity + (1));
var G__59016 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__59017){
var vec__59018 = p__59017;
var arity = cljs.core.nth.call(null,vec__59018,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__59018,(1),null);
...
return (function (p1__59021_SHARP_){
return cljs.core.get.call(null,arities,p1__59021_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__59022_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___59029 = arguments.length;
var i__4500__auto___59030 = (0);
while(true){
if((i__4500__auto___59030 < len__4499__auto___59029)){
args__4502__auto__.push((arguments[i__4500__auto___59030]));

var G__59031 = (i__4500__auto___59030 + (1));
i__4500__auto___59030 = G__59031;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__59025){
var vec__59026 = p__59025;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__59026,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq59023){
var G__59024 = cljs.core.first.call(null,seq59023);
var seq59023__$1 = cljs.core.next.call(null,seq59023);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59024,seq59023__$1);
});
...
var G__59032 = arg;
var G__59032__$1 = (((G__59032 instanceof cljs.core.Keyword))?G__59032.fqn:null);
switch (G__59032__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__59034__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__59034__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__59034__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__59034__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__59035 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__59035,(0),null);
var fn_name = cljs.core.nth.call(null,vec__59035,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__59035,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__59035,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__59035,(4),null);
var arity = cljs.core.nth.call(null,vec__59035,(5),null);
...
var o__38984__auto__ = f;
return (o__38984__auto__["getBasis"]).call(o__38984__auto__);
});
/**
...
}catch (e59039){var _e__38991__auto__ = e59039;
...
var G__59040 = (obj[cljs.core.first.call(null,path)]);
var G__59041 = cljs.core.rest.call(null,path);
obj = G__59040;
path = G__59041;
continue;
} else {
...
return (function (accum,p__59042){
var vec__59043 = p__59042;
var bit = cljs.core.nth.call(null,vec__59043,(0),null);
var protocol = cljs.core.nth.call(null,vec__59043,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__59046){
var vec__59047 = p__59046;
var ns = cljs.core.nth.call(null,vec__59047,(0),null);
var name = cljs.core.nth.call(null,vec__59047,(1),null);
var selector = cljs.core.nth.call(null,vec__59047,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__59052,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__59052,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__59052,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__59050_SHARP_){
return (obj[cljs.core.first.call(null,p1__59050_SHARP_)]);
});})(name,sorted_matches,vec__59052,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1600694564632
