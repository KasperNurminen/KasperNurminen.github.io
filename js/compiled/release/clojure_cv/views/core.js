...
var current_section = (function (){var G__4617 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$current_DASH_section], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__4617) : re_frame.core.subscribe.call(null,G__4617));
})();
...
return (function (){
var G__4618 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$set_DASH_current_DASH_section,id], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__4618) : re_frame.core.dispatch.call(null,G__4618));
});})(current_section))
,(600));

var G__4619 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scroll_DASH_into_DASH_view,id], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__4619) : re_frame.core.dispatch.call(null,G__4619));
});})(current_section))
...
var menu_open = (function (){var G__4620 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$menu_DASH_open], null);
...
var scroll_is_at_beginning = (function (){var G__4621 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scroll_DASH_is_DASH_at_DASH_beginning], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__4621) : re_frame.core.subscribe.call(null,G__4621));
})();
var current_section = (function (){var G__4622 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$current_DASH_section], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__4622) : re_frame.core.subscribe.call(null,G__4622));
})();
...
var image_enlarged = (function (){var G__4623 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$image_DASH_enlarged], null);
...
var header_class_names = (function (){var G__4624 = "";
var G__4624__$1 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4624),"header"].join('')
;
var G__4624__$2 = (cljs.core.truth_(cljs.core.deref(menu_open))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4624__$1)," header-expanded"].join(''):G__4624__$1);
var G__4624__$3 = (cljs.core.truth_((function (){var and__3911__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("main",cljs.core.deref(current_section));
if(and__3911__auto__){
return cljs.core.deref(scroll_is_at_beginning);
} else {
return and__3911__auto__;
}
})())?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4624__$2)," black"].join(''):G__4624__$2);
var G__4624__$4 = ((is_portfolio_page_QMARK_)?[cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4624__$3)," pos-absolute"].join(''):G__4624__$3);
if(cljs.core.truth_(cljs.core.deref(image_enlarged))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4624__$4)," hidden"].join('');
} else {
return G__4624__$4;
}
})();
...
return (function (){
var G__4625 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigate_DASH_to_DASH_portfolio], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__4625) : re_frame.core.dispatch.call(null,G__4625));
...
return (function (){
var G__4626 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$toggle_DASH_menu], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__4626) : re_frame.core.dispatch.call(null,G__4626));
});})(menu_open,scroll_is_at_beginning,current_section,is_portfolio_page_QMARK_,image_enlarged,header_class_names))
...
var prev_section = (function (){var G__4629 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$current_DASH_section], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__4629) : re_frame.core.subscribe.call(null,G__4629));
})();
var inner_height = window.innerHeight;
var identity_or_last_section = ((function (scroll_y,prev_section,inner_height){
return (function (p1__4627_SHARP_){
if(cljs.core.truth_(p1__4627_SHARP_)){
return p1__4627_SHARP_;
} else {
...
return ((0) < ((p1__4628_SHARP_.offsetTop - scroll_y) - (- (inner_height / (2)))));
});})(scroll_y,prev_section,inner_height,identity_or_last_section))
,sections))).id;
var G__4630_4632 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scroll_DASH_is_DASH_at_DASH_beginning,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((0),scroll_y)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__4630_4632) : re_frame.core.dispatch.call(null,G__4630_4632));

if(!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(prev_section),current_section))){
var G__4631 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$set_DASH_current_DASH_section,current_section], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__4631) : re_frame.core.dispatch.call(null,G__4631));
} else {
return null;
}
});
clojure_cv.views.core.on_resize = (function clojure_cv$views$core$on_resize(){
var menu_open = (function (){var G__4633 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$menu_DASH_open], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__4633) : re_frame.core.subscribe.call(null,G__4633));
})();
...
var G__4634 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$toggle_DASH_menu], null);
...
var menu_open = (function (){var G__4635 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$menu_DASH_open], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__4635) : re_frame.core.subscribe.call(null,G__4635));
})();
var current_section = (function (){var G__4636 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$current_DASH_section], null);
...
return (function (){
var G__4638 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scroll_DASH_into_DASH_view,"main"], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__4638) : re_frame.core.dispatch.call(null,G__4638));
});})(menu_open,current_section))
...
return (function (){
var G__4639 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scroll_DASH_into_DASH_view,"main"], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__4639) : re_frame.core.dispatch.call(null,G__4639));
});})(menu_open,current_section))
