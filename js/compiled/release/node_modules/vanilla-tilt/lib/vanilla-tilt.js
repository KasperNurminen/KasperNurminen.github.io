goog.provide("module$Users$kaspernurminen$Development$clojure_website$node_modules$vanilla_tilt$lib$vanilla_tilt");
var module$Users$kaspernurminen$Development$clojure_website$node_modules$vanilla_tilt$lib$vanilla_tilt = {};
var classCallCheck$$module$Users$kaspernurminen$Development$clojure_website$node_modules$vanilla_tilt$lib$vanilla_tilt = function(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
};
module$Users$kaspernurminen$Development$clojure_website$node_modules$vanilla_tilt$lib$vanilla_tilt["default"] = function() {
  function VanillaTilt(element) {
    var settings = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    classCallCheck$$module$Users$kaspernurminen$Development$clojure_website$node_modules$vanilla_tilt$lib$vanilla_tilt(this, VanillaTilt);
...
if (typeof document !== "undefined") {
  window.VanillaTilt = module$Users$kaspernurminen$Development$clojure_website$node_modules$vanilla_tilt$lib$vanilla_tilt["default"];
  module$Users$kaspernurminen$Development$clojure_website$node_modules$vanilla_tilt$lib$vanilla_tilt["default"].init(document.querySelectorAll("[data-tilt]"));
}
