...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__5762 = cljs.core.instance_QMARK_;
var expr__5763 = reactive_val;
if(cljs.core.truth_((pred__5762.cljs$core$IFn$_invoke$arity$2 ? pred__5762.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__5763) : pred__5762.call(null,reagent.ratom.RAtom,expr__5763)))){
return "ra";
} else {
if(cljs.core.truth_((pred__5762.cljs$core$IFn$_invoke$arity$2 ? pred__5762.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__5763) : pred__5762.call(null,reagent.ratom.RCursor,expr__5763)))){
return "rc";
} else {
if(cljs.core.truth_((pred__5762.cljs$core$IFn$_invoke$arity$2 ? pred__5762.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__5763) : pred__5762.call(null,reagent.ratom.Reaction,expr__5763)))){
return "rx";
} else {
if(cljs.core.truth_((pred__5762.cljs$core$IFn$_invoke$arity$2 ? pred__5762.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__5763) : pred__5762.call(null,reagent.ratom.Track,expr__5763)))){
return "tr";
} else {
return "other";
}
